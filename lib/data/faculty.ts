...
export const facultyData: Lecturer[] = [
  {
    ...
    publicationsList: [
      {
        title:
          "Federated Learning for Healthcare: Privacy-Preserving Machine Learning in Resource-Constrained Settings",
      ...
      {
        title:
          "Bias Mitigation in Natural Language Processing Models for African Languages",
      ...
      {
        title:
          "Deep Learning Architectures for Low-Resource Language Translation",
  ...
  {
    id: 2,
    name: "Dr. Obasohan E.E.",
    role: "Senior Lecturer",
    rank: "Senior Lecturer",
    department: "Department of Data Science",
    image:
      "https://images.unsplash.com/photo-1573496527892-904f897eb744?w=1080&q=80",
    email: "o.e.e@uniben.edu.ng",
    phone: "+234 (0) 809 111 2222",
    office: "Block C, Room 305",
    bio: `Dr. Obasohan E.E. is a specialist in big data analytics, cloud computing, and distributed data systems. She completed her Ph.D. at Imperial College London. Her research aims at building high-throughput, fault-tolerant ETL pipelines and applying machine learning to real-time industrial data.
    ...
    publicationsList: [
      {
        title:
          "High-Throughput Stream Processing for Smart Grid Infrastructure in Africa",
  ...
  },
  {
    ...
    department: "Department of Data Science",
    image:
      "https://images.unsplash.com/photo-1533108344127-a586d2b02479?w=1080&q=80",
    email: "i.igodan@uniben.edu.ng",
    phone: "+234 (0) 809 111 2222",
    office: "Block C, Room 305",
    bio: `Dr. Igodan E. C.'s research bridges data visualization, human-computer interaction, and public health informatics. She completed her doctorate at Carnegie Mellon University. 

    He has developed open-source visualization platforms deployed across West Africa to help public health agencies track epidemics and make evidence-based policy decisions.`,
    research: [
      "Data Visualization",
    ...
    publicationsList: [
      ...
      {
        title:
          "Cognitive Load and Decision Quality: Evaluating Data Visualizations for Epidemic Monitoring",
  ...
  },
  {
    ...
    department: "Department of Data Science",
    image:
      "https://images.unsplash.com/photo-1688120320082-f23f0c1425be?w=1080&q=80",
    email: "e.nwankwo@uniben.edu.ng",
    phone: "+234 (0) 802 333 4444",
    office: "Block C, Room 302",
    bio: `Dr Odigie B. B. is a renowned statistician with over 25 years of research experience in biostatistics, Bayesian inference, and statistical modeling. He holds a D.Sc. from the University of Lagos.
    ...
    publicationsList: [
      ...
      {
        title:
          "Survival Analysis Models for Malaria Intervention Program Assessment",
        journal: "Biometrics",
        year: "2023",
        citations: 91,
      },
  ...
  },
  {
    ...
    department: "Department of Data Science",
    image:
      "https://images.unsplash.com/photo-1631131431211-4f768d89087d?w=1080&q=80",
    ...
    publicationsList: [
      {
        title:
          "YorubaBERT: Pre-trained Language Model for Yoruba Text Classification",
    ...
    awards: ["Google African Research Award (2025)"],
  },
  {
    id: 6,
    name: "Dr. Amara Nwosu",
    ...
    department: "Department of Data Science",
    image:
      "https://images.unsplash.com/photo-1530785602389-07594beb8b73?w=1080&q=80",
    ...
    publicationsList: [
      {
        title:
          "Deep CNNs for Crop Identification using Sentinel-2 Imagery in Nigeria",
  ...
  },
  {
    ...
    department: "Department of Data Science",
    image:
      "https://images.unsplash.com/photo-1723221906960-1c5a5febc9c3?w=1080&q=80",
    ...
    publicationsList: [
      {
        title:
          "EdgeRL: Efficient Reinforcement Learning on Embedded Microcontrollers",
    ...
    awards: ["Edinburgh Global Research Scholarship (2020)"],
  },
  {
    id: 8,
    ...
    department: "Department of Data Science",
    image:
      "https://images.unsplash.com/photo-1546838692-669d40506ade?w=1080&q=80",
    ...
    publicationsList: [
      {
        title:
          "Privacy-Preserving Architectures for Federated Health Records in Ghana and Nigeria",
    ...
    awards: ["Global Health Equity Research Award (2023)"],
  },
];