...
export const metadata: Metadata = {
  ...
  description:
    "Explore our B.Sc, Postgraduate Diploma, and M.Sc academic programmes in Data Science and Data Analytics at the University of Benin.",
};
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <div className="relative bg-muted border-b border-border overflow-hidden">
        <div className="max-w-300 mx-auto px-4 md:px-6 lg:px-8 py-14 relative z-10">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl">
            Three distinct pathways into data science — from undergraduate study
            to advanced research. Find the programme that fits your goals.
          </p>
        </div>
        {/* Blue blur accent */}
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse at 100% 50%, rgba(56,142,237,0.1) 0%, transparent 75%)",
          }}
        />
      </div>
      ...
      <section className="bg-muted border-b border-border">
        <div className="max-w-300 mx-auto px-4 md:px-6 lg:px-8 py-16">
          ...
          <p className="text-muted-foreground mb-12 text-lg max-w-2xl">
            We blend academic rigour with practical depth to produce graduates
            who are immediately effective in industry or research.
          </p>
            ...
            {[
              {
                ...
                desc: "All programmes hold full accreditation from the National Universities Commission, recognised across Nigeria and internationally.",
              },
              {
                icon: <Users className="w-6 h-6" />,
                title: "Industry Integration",
                desc: "Partnerships with Google, Microsoft, Flutterwave, and 25+ others bring live projects, internships, and job pipelines directly to students.",
              },
              {
                icon: <BookOpen className="w-6 h-6" />,
                title: "Research-Led Teaching",
                desc: "Our faculty are active researchers. Classroom knowledge is shaped by what is happening at the frontier of data science today.",
              },
              {
                icon: <Clock className="w-6 h-6" />,
                title: "Flexible Scheduling",
                desc: "Evening and weekend classes on select programmes make it possible to study while continuing professional work.",
              },
              {
                icon: <CheckCircle className="w-6 h-6" />,
                title: "94% Employment Rate",
                desc: "The majority of our graduates secure relevant employment within six months of completing their programme.",
              },
              {
                icon: <ArrowRight className="w-6 h-6" />,
                title: "Clear Progression",
                desc: "A structured pathway from B.Sc → PGD → M.Sc → PhD means you can grow with us at every stage of your career.",
              },
            ].map((item, i) => (
        ...
        <div className="max-w-300 mx-auto px-4 md:px-6 lg:px-8 py-16">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
            <div className="lg:col-span-4">
              <h2 className="text-3xl md:text-[40px] mb-4">
                Frequently Asked Questions
              </h2>
              <p className="text-muted-foreground leading-relaxed mb-6">
                Can't find your answer? Reach out to our admissions office
                directly.
              </p>
              <a href="mailto:admissions@uniben.edu.ng">
                <Button
                  variant="outline"
                  className="border-2 border-primary text-primary hover:bg-primary hover:text-primary-foreground px-6"
                >
                  Contact Admissions
                </Button>
              </a>
            ...
            <div className="lg:col-span-8 space-y-0">
              {faqs.map((faq, i) => (
                ...
                >
                  <h4
                    className="font-medium text-foreground mb-3 text-[16px]"
      ...
      <section className="bg-primary text-primary-foreground">
        <div className="max-w-300 mx-auto px-4 md:px-6 lg:px-8 py-16 text-center">
          <h2
          ...
          <p className="text-primary-foreground/80 text-lg mb-8 max-w-xl mx-auto">
            Applications are open. Take the first step toward a career in data
            science.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link href="/about">
              <Button
                variant="outline"
                className="border-2 border-primary-foreground bg-primary px-8 py-6 text-base text-primary-foreground hover:text-primary"
              >
                Learn More About Us
              </Button>
            </Link>
