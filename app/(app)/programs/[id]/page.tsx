    ...
    <div className="bg-background text-foreground">
      ...
      <section className="bg-muted border-b border-border">
        <div className="max-w-300 mx-auto px-4 md:px-6 lg:px-8 py-12 md:py-16">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <Button
              variant="outline"
              className="border-2 border-primary text-primary bg-transparent hover:bg-primary hover:text-primary-foreground px-8 py-6 text-lg rounded-sm "
            >
              Request Information
            </Button>
          </div>
      ...
      <div className="max-w-300 mx-auto px-4 md:px-6 lg:px-8 py-12 ">
        <Accordion type="single" collapsible className="space-y-4">
          ...
          >
            <AccordionTrigger
              className="text-2xl py-6 hover:no-underline hover:text-primary text-foreground font-bold"
              style={{ fontFamily: "var(--font-serif)" }}
            >
              Program Overview
            </AccordionTrigger>
          ...
          <AccordionItem
            value="careers"
            className="border border-border px-5 bg-background overflow-y-visible"
          >
            <AccordionTrigger
              className="text-2xl py-6 hover:no-underline hover:text-primary text-foreground font-bold"
              style={{ fontFamily: "var(--font-serif)" }}
            ...
            <AccordionContent className="pb-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {program.careers.map((career, index) => (
                  <div
                    key={index}
                    className="border-l-4 border-primary pl-6 py-3 bg-muted/20"
                  >
                    <h4
              ...
              <div className="mt-8 p-6 bg-muted border border-border">
                <p className="text-muted-foreground leading-relaxed">
                  Our graduates have secured positions at leading organizations
                  including Google, Microsoft, Amazon, Andela, Flutterwave, and
                  various research institutions. Many have also founded
                  successful startups or pursued advanced degrees at top
        ...
        <div className="mt-12 bg-primary text-primary-foreground p-8 md:p-12 text-center rounded-sm">
          ...
          <p className="text-lg mb-8 max-w-2xl mx-auto opacity-90">
            Join the next generation of data scientists and make an impact
