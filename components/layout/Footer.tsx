    ...
    <footer className="bg-neutral-900 text-white border-t border-white/5">
      <div className="max-w-[1200px] mx-auto px-4 md:px-6 lg:px-8 py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
          {/* About */}
          <div>
            <h3 className="font-bold text-white mb-4" style={{ fontFamily: 'var(--font-sans)' }}>UNIBEN Data Science</h3>
          ...
          {/* Quick Links */}
          <div>
            <h4 className="font-medium text-white mb-4" style={{ fontFamily: 'var(--font-sans)' }}>Quick Links</h4>
            <ul className="space-y-2 text-sm">
              <li><Link href="/news" className="text-neutral-400 hover:text-primary transition-colors">News & Events</Link></li>
              <li><Link href="/programs" className="text-neutral-400 hover:text-primary transition-colors">Programs</Link></li>
              ...
              <li><Link href="/lecturers" className="text-neutral-400 hover:text-primary transition-colors">Faculty</Link></li>
            </ul>
          </div>

          {/* Contact */}
          <div>
            <h4 className="font-medium text-white mb-4" style={{ fontFamily: 'var(--font-sans)' }}>Contact Us</h4>
